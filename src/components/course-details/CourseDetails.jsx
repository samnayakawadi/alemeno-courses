const CourseDetails = () => {
    return (
        <div>
            <div className="flex flex-row justify-center items-center my-10 mx-20 gap-10 p-10 border">
                <div className="basis-6/12 flex flex-col gap-5">
                    <h1>Founders Master Class : 7 Essential Steps for Startups</h1>
                    <h3>Product Design Program</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil, vero aspernatur? Doloribus ratione delectus blanditiis quasi doloremque, quisquam repellendus, officiis facere corrupti est at ducimus ipsa voluptas consectetur incidunt unde vero molestias quod! Aspernatur nulla cumque asperiores? Beatae, totam libero.</p>
            ...
            <div className="mx-20 my-10">
                ...
                <div className="flex gap-5 mt-5">
                    <div className="basis-4/12 flex flex-col items-center p-10 gap-3 border rounded-lg">
            ...
            <div className="mx-20 my-10">
                ...
                <div className="grid grid-cols-3 mt-5 gap-5">
                    ...
                    <p className="text-center p-10 border rounded-lg">Basic React</p>
                </div>
            </div>
                ...
                <div className="flex flex-col gap-5 mt-5">
                    <div className="collapse collapse-plus border">
                        ...
                        <div className="collapse-content">
                            <p>Overview of React Native, setting up your development environment</p>
                        </div>
                    </div>
                    <div className="collapse collapse-plus border">
                        <input type="radio" name="my-accordion-3" checked="checked" />
